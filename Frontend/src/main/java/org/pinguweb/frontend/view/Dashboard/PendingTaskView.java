...
public class PendingTaskView extends VerticalLayout {
    ...
    public PendingTaskView() {
        ...
        pieConf.setTitle("Pending Task Distribution");

        DataSeries pieSeries = new DataSeries();
        //TODO: Aqui tengo que extraer de la base de datos para rellenar la tarta
        pieSeries.add(new DataSeriesItem("Tarea 1", 10));
        pieSeries.add(new DataSeriesItem("Tarea 2", 20));
        pieSeries.add(new DataSeriesItem("Tarea 3", 30));
        pieSeries.add(new DataSeriesItem("Tarea 4", 40));
        pieConf.setSeries(pieSeries);

        Chart barChart = new Chart(ChartType.BAR);
        Configuration barConfig = barChart.getConfiguration();
        barConfig.setTitle("Pending Task Distribution");

        DataSeries barSeries = new DataSeries();
        //TODO: Aqui tengo que extraer de la base de datos para rellenar la barra
        barSeries.add(new DataSeriesItem("Tarea 1", 10));
        barSeries.add(new DataSeriesItem("Tarea 2", 20));
        barSeries.add(new DataSeriesItem("Tarea 3", 30));
        barSeries.add(new DataSeriesItem("Tarea 4", 40));
